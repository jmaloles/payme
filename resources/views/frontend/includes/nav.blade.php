                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="#" data-toggle="modal" data-target="#requestModal">Create Request</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#viewModal" onclick="getAllRequest()">View Requests</a></li>
                        </ul>
                    </li>
